...
// Only apply GSAP scroll snapping for non-mobile devices (desktop/tablet)
if (!isMobile) {
    // GSAP Observer to capture wheel/touch/pointer inputs for smooth scrolling
    Observer.create({
    ...
    // On mobile, we disable any smooth scroll functionality to use native scroll
    console.log("Regular mobile scroll enabled");
    // In case mobile devices need to load the first section or just act as default scroll
